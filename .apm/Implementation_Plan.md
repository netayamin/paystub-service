...
**Last Modification:** Manager overnight batch: Task 1.5 `invariant_checks` + script + pytest; Task 2.2 discovery scheduler doc; Tasks 4.1/3.4 feed API docs + `debug=1` `_debug_rank`; Task 5.1 iOS `Drop` eligibility fields; Task 6.2 ship checklist in SCALABILITY_AND_MAINTENANCE. Phases 7–9 still gated.
